        ...
        <div class="row">
            ...
            <div class="credits ml-auto">
                <span class="copyright">
                    ...
                    </script> <a class="@if(Auth::guest()) text-white @endif" href="#" target="_blank">{{ __('Capital Amigo') }}</a>{{ __(' & ') }}<a class="@if(Auth::guest()) text-white @endif" target="_blank" href="#">{{ __('Tooring') }}</a>
                </span>
            </div>
        </div>
    </div>
